...
%=====================================================================
\chapter{Hypothesis 2: [Title to be supplied]}
\label{ch:h2}

\section{Hypothesis and pre-commitment}
\label{sec:h2-hypothesis}

\begin{keybox}{Hypothesis 2}
...
\label{sec:h2-descriptives}
\label{sec:h2-diagnostics}
...
\label{sec:h2-results}
\label{sec:h2-robustness}
...
\label{sec:h2-verdict}
\label{sec:h2-implications}
\label{sec:h2-limitations}
